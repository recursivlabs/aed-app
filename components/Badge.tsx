...
function badgeConfig(colors: ColorTokens): Record<BadgeType, { icon: string; color: string; label: string; bg: string }> {
  return {
    gold: { icon: 'checkmark', color: colors.accent, label: 'AED Connect Plus', bg: colors.accentMuted },
    ...
    plus: { icon: 'checkmark', color: colors.accent, label: 'AED Connect Plus', bg: colors.accentMuted },
  };
}
