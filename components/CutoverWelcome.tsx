        ...
        >
          ...
          <View style={{ flex: 1, maxWidth: 760 }}>
            <Text variant="caption" color={colors.text}>
              <Text variant="bodyMedium" color={colors.text}>Welcome to Minds 2.0. </Text>
        ...
        >
          ...
          >
            ...
            <View style={{ gap: spacing.sm }}>
              <Text variant="h2" color={colors.text}>Welcome back to Minds</Text>
            ...
            <View style={{ gap: spacing.sm }}>
              ...
              >
                <Text variant="bodyMedium" color={colors.textOnAccent}>Continue to Minds</Text>
              </Pressable>
              <Pressable
                accessibilityRole="button"
                accessibilityLabel="Tell us what is missing"
