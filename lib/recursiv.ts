...
export const ORG_ID =
  process.env.EXPO_PUBLIC_RECURSIV_ORG_ID || '01a0a598-c6af-7121-9dc7-f4af5bb64283';
export const PROJECT_ID =
  process.env.EXPO_PUBLIC_RECURSIV_PROJECT_ID || '01a0a598-e4c0-77ee-9ede-e5cae491afac';
